  ...
  ["chunk-3630c732"],
  {
    ...
    "9ed6": function (e, o, s) {
      ...
      var t = function () {
          ...
          return o(
            ...
            [
              o(
                ...
                [
                  o("div", { staticClass: "title-container" }, [
                    o("h3", { staticClass: "title" }, [e._v("在线考试平台")]),
                  ]),
                  o(
                    "el-form-item",
                    { attrs: { prop: "userName" } },
                    [
                      o(
                        ...
                        [o("svg-icon", { attrs: { "icon-class": "user" } })],
                        1
                      ),
                      o("el-input", {
                        ref: "userName",
                        ...
                        [
                          ...
                          o("el-input", {
                            ...
                            nativeOn: {
                              keyup: [
                                function (o) {
                                  return e.checkCapslock.apply(null, arguments);
                                },
                                function (o) {
        ...
        n = [
          function () {
            ...
            return o("div", { staticClass: "account-foot-copyright" }, [
              o("span", [e._v("Copyright ©2019-2024 nicky 版权所有")]),
            ]);
          },
        ],
        a = s("5530"),
        r = (s("d9e2"), s("14d9"), s("2f62")),
        i = s("7ded"),
        l = {
          name: "Login",
          data: function () {
            var e = function (e, o, s) {
                      ...
                      .then(function (e) {
                        e && 1 === e.code
                          ? (o.setUserName(o.loginForm.userName),
                            o.$router.push({ path: "/" }))
                          : ((o.loading = !1),
                            o.$message({ message: e.message, type: "error" }));
                      })
                      .catch(function (e) {
                        o.loading = !1;
                      });
        ...
        c = l,
        p = (s("dac0"), s("c2d4"), s("2877")),
        u = Object(p["a"])(c, t, n, !1, null, "fe246514", null);
      o["default"] = u.exports;
    },
    c2d4: function (e, o, s) {
      "use strict";
